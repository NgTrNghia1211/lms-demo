...
const ChapterIdPage = async ({
  ...
  const completionText = `(${completedFields}/${totalFields}) required`
  ...
  return (
    <>
      {!chapter.isPublished && (
        <Banner 
          variant={'warning'}
          label="This chapter is not published. It will not be visible in this course"  
        />
      )}
      <div
        style={{
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grids-cols-2 gap-6 mt-16">
